import{w3 as K,GH as Z,GI as ee,Fi as te,Fg as ie,GJ as re,GK as ae,Fn as o,GA as se,FW as oe,Gz as ne,Fm as w,GL as ce,GM as le,Fj as pe,Fl as de,Fo as he,Gj as ve,Fq as ue,GN as A,GO as N,GP as me,GQ as fe,F_ as ge,fO as Se,Fr as Pe,Fs as ye,_ as _e,Ft as C,Fu as E,Fv as we,Fw as R,Fx as L,G0 as ze,Fz as xe,FA as $e,FB as Te,FD as V,FE as be,GR as Ve,GS as U,GT as I,GU as ke,GV as Oe,GW as Fe,FF as De,n as p,FG as d,fL as We,G1 as Ce,GX as B,qC as Le,Gr as Me,kE as je,FL as Ge,c9 as q,xX as Ae,gl as H,ck as Y,GY as Ne}from"./index-540L_QF2.js";function J(r){const e=new K,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
